...
def test_any_on_ndarray():
    @zk_circuit
    def foo():
        assert any(np.asarray([True, True, True, True, True])) == True
        assert any(np.asarray([True, True, False, False, False])) == True
        assert any(np.asarray([False, False, False, False, False])) == False
...
def test_all_on_ndarray():
    @zk_circuit
    def foo():
        assert all(np.asarray([True, True, True, True, True])) == True
        assert all(np.asarray([True, True, False, False, False])) == False
        assert all(np.asarray([False, False, False, False, False])) == False
...
def test_any_on_multidim_ndarray():
    ...
    def foo():
        assert any(np.asarray([[True, True], [True, True]])) == [True, True]
        assert any(np.asarray([[True, True], [False, False]])) == [True, True]
        assert any(np.asarray([[False, False], [False, False]])) == [False, False]
