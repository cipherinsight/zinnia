...
class IRContext:
    ...
    def chip_enter(self, return_dtype: DTDescriptor, assertion_condition: BooleanValue):
    ...
    def loop_break(self, condition: BooleanValue | None = None):
        assert self.scopes[-1].is_in_loop()
    ...
    def if_enter(self, condition: BooleanValue):
    ...
    def get_condition_value(self) -> BooleanValue:
        ...
        if len(conditions) == 0:
            return self.ir_builder.ir_constant_bool(True)
    ...
    def get_condition_value_for_assertion(self) -> BooleanValue:
