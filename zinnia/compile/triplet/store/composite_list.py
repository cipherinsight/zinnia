...
from zinnia import List
from zinnia.compile.triplet.store import ValueStore
from zinnia.compile.type_sys import DTDescriptor


class CompositeListValueStore(ValueStore):
    def __init__(self, elements_type: List[DTDescriptor], values: List[ValueStore]):
        self.elements_type = elements_type
        self.values = values

    def assign(self, other: 'CompositeListValueStore') -> 'CompositeListValueStore':
