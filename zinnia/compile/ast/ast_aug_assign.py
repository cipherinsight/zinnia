...
class ASTAugAssignStatement(ASTStatement):  # only for subscript assignment
    def __init__(self, dbg: DebugInfo, targets: List[ASTAssignTarget], op_type: str, value: ASTExpression):
        super().__init__(dbg)
