...
class AbstractIntegerArithemetic(AbstractOp):
    ...
    def build_number_and_number(self, builder: IRBuilderInterface, lhs: IntegerValue, rhs: IntegerValue) -> Value:
        return self.get_build_op_lambda(builder)(lhs, rhs)

    def build_number_and_ndarray(self, builder: IRBuilderInterface, lhs: IntegerValue, rhs: NDArrayValue) -> Value:
    ...
    def build_ndarray_and_number(self, builder: IRBuilderInterface, lhs: NDArrayValue, rhs: IntegerValue) -> Value:
