...
from zinnia.compile.type_sys.ndarray_bounds import (
    infer_ndarray_compile_bounds_from_shape,
)
...
class NP_ZerosOp(AbstractOp):
    ...
    def build(self, builder: IRBuilderInterface, kwargs: OpArgsContainer, dbg: Optional[DebugInfo] = None) -> Value:
        ...
        if is_dynamic:
            return builder.op_dynamic_ndarray_zeros(shape, dtype, dbg)
        ...
        if parsed_dtype == FloatType:
            ...
            return NDArrayValue.fill(parsed_shape, BooleanType, lambda: builder.ir_constant_bool(False))
        else:
