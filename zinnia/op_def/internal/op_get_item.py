...
from zinnia.compile.triplet import Value, ListValue, TupleValue, IntegerValue, NDArrayValue
...
class GetItemOp(AbstractItemSliceOp):
    ...
    def _build_tuple_list_slicing(self, builder: IRBuilderInterface, the_self: TupleValue | ListValue, slicing_param: TupleValue | IntegerValue, dbg: Optional[DebugInfo] = None) -> Value:
