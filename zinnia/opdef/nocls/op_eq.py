    ...
    def build(self, builder: AbsIRBuilderInterface, kwargs: Dict[str, Value], dbg: Optional[DebugInfo] = None) -> Value:
        ...
        if isinstance(lhs, TupleValue) and isinstance(rhs, TupleValue):
            ...
            for l, r in zip(lhs.values(), rhs.values()):
                result = builder.ir_logical_and(result, builder.op_bool_scalar(builder.op_equal(l, r)))
            return result
            ...
            return builder.op_equal(lhs, builder.op_ndarray_asarray(rhs, dbg), dbg)
        elif isinstance(lhs, ListValue) and isinstance(rhs, NDArrayValue):
            return builder.op_equal(builder.op_ndarray_asarray(lhs, dbg), rhs, dbg)
