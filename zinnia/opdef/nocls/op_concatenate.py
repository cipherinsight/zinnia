...
from zinnia.compile.builder.value import Value, IntegerValue, NDArrayValue, TupleValue
...
class ConcatenateOp(AbstractOp):
    ...
    def build(self, builder: AbsIRBuilderInterface, kwargs: Dict[str, Value], dbg: Optional[DebugInfo] = None) -> Value:
        ...
        for arg in args.values():
            sources.append(builder.op_float_cast(arg) if expected_float and arg.dtype() != FloatType else arg)
