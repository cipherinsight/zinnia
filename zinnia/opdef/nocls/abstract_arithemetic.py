...
from zinnia.compile.builder.value import NDArrayValue, NumberValue, Value
...
class AbstractArithemetic(AbstractOp):
    ...
    def build_number_and_number(self, builder: AbsIRBuilderInterface, lhs: NumberValue, rhs: NumberValue) -> Value:
        return self.get_build_op_lambda(builder)(lhs, rhs)

    def build_number_and_ndarray(self, builder: AbsIRBuilderInterface, lhs: NumberValue, rhs: NDArrayValue) -> Value:
    ...
    def build_ndarray_and_number(self, builder: AbsIRBuilderInterface, lhs: NDArrayValue, rhs: NumberValue) -> Value:
