...
from zinnia.compile.builder.value import Value, ListValue, TupleValue, IntegerValue, NoneValue
...
class AbstractItemSliceOp(AbstractOp):
    ...
    def insert_slicing_number_assertion(self, number: IntegerValue, dim: int, builder: AbsIRBuilderInterface):
        ...
        builder.op_assert(builder.ir_logical_not(is_out_of_range), None)
