...
from pyzk.internal.inference_descriptor import InferenceDescriptor, NDArrayInferenceDescriptor, NumberInferenceDescriptor
...
class AbstractAggregator(AbstractOp):
    ...
    def type_check(self, dbg_i: Optional[DebugInfo], kwargs: Dict[str, InferenceDescriptor]) -> DTDescriptor:
        ...
        if the_axis is None:
            ...
            raise TypeInferenceError(dbg_i, "Param `axis` must be of type `Number`")
