...
class NDArray_ZerosOp(AbstractOp):
    ...
    def build(self, reducer: AbsIRBuilderInterface, kwargs: Dict[str, Value], dbg: Optional[DebugInfo] = None) -> Value:
        ...
        if parsed_dtype == FloatType:
            return NDArrayValue.fill(parsed_shape, FloatType, lambda: reducer.ir_constant_float(0.0))
        elif parsed_dtype == IntegerType:
            return NDArrayValue.fill(parsed_shape, IntegerType, lambda: reducer.ir_constant_int(0))
        else:
