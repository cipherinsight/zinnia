# Source: Pythran tests/cases/d2q9_nxnyns.py
# Original #pythran export: one_time_step(float64[][][], float64[][][])
from zinnia import *
...
@zk_circuit
def one_time_step(f1: NDArray[Float, 16, 16, 9], f2: NDArray[Float, 16, 16, 9]):
    nx, ny, ns = f1.shape
    floc = np.zeros(ns)
    mloc = np.zeros(ns)
