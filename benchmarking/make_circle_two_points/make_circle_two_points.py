# Source: Pythran tests/cases/make_circle_two_points.py
# Original #pythran export: make_circle_two_points((float,float) list, (float, float), (float, float))
from zinnia import *
import math
...
@zk_circuit
def make_circle_two_points(points: float, p: float, q: float):
    ...
    if left is None and right is None:
        ...
        _zinnia_result = right
    elif right is None:
        _zinnia_result = left
    else:
        _zinnia_result = left if (left[2] <= right[2]) else right
