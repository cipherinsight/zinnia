...
# Migration notes:
#   - M, N, NNZ hoisted to module-level constants. From "S" preset (M=N=4096, nnz=8192).
...
@zk_circuit
def spmv(A_row: NDArray[Integer, 4097], A_col: NDArray[Integer, 8192],
         A_val: NDArray[Float, 8192], x: NDArray[Float, 4096]):
