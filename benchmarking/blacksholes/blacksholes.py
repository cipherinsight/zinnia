# Source: Pythran tests/cases/blacksholes.py
# Original #pythran export: BlackScholes(float list, float list, float list, float, float, int)
from zinnia import *
import math


@zk_circuit
def BlackScholes(stock_price: NDArray[Float, 64], option_strike: NDArray[Float, 64], option_years: NDArray[Float, 64],
                 Riskfree: float, Volatility: float, nb_opt: int):
    ...
    _zinnia_result = call_result, put_result
