...
def run_evaluate(dataset: str, problem: str):
    ...
    config = ZinniaConfig(optimization_config=OptimizationConfig(
        ...
        dead_code_elimination=False if ABLATION_SETTING == 2 else True,
        duplicate_code_elimination=False if ABLATION_SETTING == 3 else True,
        shortcut_optimization=False if ABLATION_SETTING == 4 else True  # actually pattern matching
    ))
...
DS1000 = [
    'case295', 'case296', 'case297', 'case298', 'case299', 'case300', 'case301', 'case302', 'case303', 'case304', 'case309', 'case310',
    'case313', 'case318', 'case319', 'case322', 'case323', 'case324', 'case329', 'case330', 'case334', 'case335', 'case336', 'case337',
    'case338', 'case339', 'case353', 'case354', 'case360', 'case368', 'case369', 'case370', 'case373', 'case374', 'case375', 'case385',
    'case387', 'case388', 'case389', 'case390', 'case391', 'case392', 'case393', 'case406', 'case407', 'case408', 'case409', 'case414',
    'case415', 'case416', 'case417', 'case418', 'case419', 'case420', 'case428', 'case429', 'case430', 'case431', 'case433', 'case434',
    'case435', 'case436', 'case437', 'case438', 'case440', 'case441', 'case452', 'case453', 'case459', 'case480', 'case501', 'case507',
    'case510'
]
CRYPT = [
    "ecc",
