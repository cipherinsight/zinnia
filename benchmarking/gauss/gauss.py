# Source: Pythran tests/cases/gauss.py
# Original #pythran export: gauss(int, float list list, float list)
from zinnia import *
...
@zk_circuit
def gauss(n: int, a: NDArray[Float, 16, 16], b: NDArray[Float, 64]):
